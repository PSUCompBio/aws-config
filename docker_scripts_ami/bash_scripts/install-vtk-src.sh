...
cmake3 .. -DBUILD_SHARED_LIBS=ON -DCMAKE_BUILD_TYPE=Release -DVTK_OPENGL_HAS_OSMESA=ON  -DVTK_USE_X=OFF -DVTK_WRAP_PYTHON=OFF -DBUILD_EXAMPLES=OFF -DBUILD_TESTING=OFF
