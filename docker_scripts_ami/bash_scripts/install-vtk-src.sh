...
gunzip vtk-v8.2.0.tar.gz
tar -xvf vtk-v8.2.0.tar
rm vtk-v8.2.0.tar
export VTK_ROOT=/home/$UNAMEX/vtk-v8.2.0
cd $VTK_ROOT
mkdir build
cd build
...
echo "VTK_ROOT=/home/$UNAMEX/vtk-v8.2.0" >> /home/$UNAMEX/.bash_profile
